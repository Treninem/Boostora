...
class FinalAuditService:
    ...
    def proposed_items() -> list[dict[str, Any]]:
        ...
        add(
            ...
            and _source_contains('miniapp_example/index.html', 'Управляй активностью', 'Standard', 'PRO', 'assets/hero-growth.svg', 'telegram-web-app.js', 'tg.ready()', 'tg.expand()', 'data-action="tasks"', 'data-action="campaigns"'),
