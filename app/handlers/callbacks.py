...
from app.services.payments import SPARKS_PACKS, VIP_STARS_PLANS, make_payload
...
def _send_stars_invoice(bot: telebot.TeleBot, call: CallbackQuery, *, title: str, description: str, payload: str, amount_stars: int) -> None:
