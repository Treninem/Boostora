...
try:
    ...
    assert WalletService.get_summary(101)['bonus_balance'] == 320
    assert WalletService.get_summary(202)['bonus_balance'] == 320
    ...
    assert WalletService.get_summary(101)['bonus_balance'] == 140
    ...
    assert WalletService.get_summary(202)['internal_balance'] == 13
